...
<body>
    <!-- <header> -->
        <!-- <nav> -->
            ...
            <!-- <a href="#"><img class="logo" src="./images/Group 29.png" alt=""></a> -->
        <!-- </nav> -->

        <div class="hero-section">
            <div class="login-form">
                <form>
                    <img src="./images/Group 29.png" class="img-size" alt="">
                    <h1>Details</h1>
                    <input type="text" class="input-place focus-ring " id="firstName" name="firstName" placeholder="First Name" required><br><br>
